...
setup(
    ...
    install_requires=[
      ...
      license = "GNU",
    entry_points = {
        "console_scripts": ['espy = espy.espy:main']
        },
    version = version,
    description = "espn score grabber",
    long_description = long_descr,
    author = "James A. Campbell",
    author_email = "james@jamescampbell.us",
    url = "https://github.com/jamesacampbell/espy",
    download_url = "https://github.com/jamesacampbell/espy/tarball/"+version,
keywords = ['sports', 'scores', 'cli'], # arbitrary keywords
  classifiers=[
